...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mWrathSettingsObserver.observe();
        mWrathSettingsObserver.update();
    ...
    private WrathSettingsObserver mWrathSettingsObserver = new WrathSettingsObserver(mHandler);
    private class WrathSettingsObserver extends ContentObserver {
        WrathSettingsObserver(Handler handler) {
            super(handler);
        }
